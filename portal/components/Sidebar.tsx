...
import { LayoutDashboard, Search, List, Shield, Database, Settings, Info, Activity, ChevronRight, GitCompare } from "lucide-react";
                ...
                {navLinks.map(({ href, label, icon: Icon }) => {
                    ...
                    return (
                        <Link key={href} href={href} onClick={onClose}
                            ...
                            style={isActive
                                ? { background: "var(--accent-bg)", border: "1px solid var(--accent-brd)", color: "var(--accent)" }
